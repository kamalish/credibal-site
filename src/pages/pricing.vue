                ...
                <div class="w-lg-80 mx-lg-auto position-relative">
                    ...
                    <figure class="max-w-11rem w-100 position-absolute top-0 right-0">
                        <div class="mt-n11 mr-n11">
                            <g-image class="img-fluid" src="~/assets/svg/components/dots-1.svg" />
                        </div>
                    </figure>
                    <figure class="max-w-13rem w-100 position-absolute bottom-0 left-0">
                        <div class="mb-3 ml-n9">
                            <g-image class="img-fluid" src="~/assets/svg/components/abstract-shapes-10.svg" />
                        </div>
                    </figure>
                    <!-- End SVG Elements -->
                </div>
                ...
                <div class="w-lg-80 mx-lg-auto">
                    <div class="row justify-content-center text-center">
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/slack.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/google.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/airbnb.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/weebly.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/spotify.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/shopify.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/amazon.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/fitbit.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/hubspot.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/kaplan.svg" alt="Image Description" />
                        </div>
                        <div class="col-4 col-sm-2 py-3">
                            <g-image class="max-w-11rem max-w-md-13rem mx-auto" src="~/assets/svg/clients-logo/paypal.svg" alt="Image Description" />
                        </div>
                    </div>
                </div>
                <!-- End Clients Section -->
