            ...
            <div class="row mx-n2">
                <div class="col-6 col-md px-2 mb-3">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img17.jpg" />
                    </div>
                </div>
                <div class="col-md-3 d-none d-md-block px-2 mb-3">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img6.jpg" />
                    </div>
                </div>
                <div class="col-6 col-md px-2 mb-3">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img14.jpg" />
                    </div>
                </div>
                ...
                <div class="col-6 col-md px-2 mb-3 mb-md-0">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img25.jpg" />
                    </div>
                </div>
                <div class="col-md-4 d-none d-md-block px-2 mb-3 mb-md-0">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img16.jpg" />
                    </div>
                </div>
                <div class="col-6 col-md px-2">
                    <div class="h-250rem bg-img-hero">
                        <g-image class="w-100" src="~/assets/img/480x320/img12.jpg" />
                    </div>
                </div>
            </div>
            <!-- End Gallery Section -->
            ...
            <div class="row mx-n2 mb-5">
                    ...
                    <div class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <div class="avatar avatar-lg avatar-circle mb-4">
                                <g-image class="avatar-img" src="~/assets/img/100x100/img1.jpg" />
                            </div>
                ...
                <div class="col-sm-6 col-lg-3 px-2 mb-3">
                    ...
                    <div class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <div class="avatar avatar-lg avatar-circle mb-4">
                                <g-image class="avatar-img" src="~/assets/img/100x100/img3.jpg" />
                            </div>
                ...
                <div class="col-sm-6 col-lg-3 px-2 mb-3">
                    ...
                    <div class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <div class="avatar avatar-lg avatar-circle mb-4">
                                <g-image class="avatar-img" src="~/assets/img/100x100/img11.jpg" />
                            </div>
                ...
                <div class="col-sm-6 col-lg-3 px-2 mb-3">
                    ...
                    <div class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <div class="avatar avatar-lg avatar-circle mb-4">
                                <g-image class="avatar-img" src="~/assets/img/100x100/img12.jpg" />
                            </div>
